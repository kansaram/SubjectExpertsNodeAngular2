...
var DataService = /** @class */ (function () {
    function DataService(http) {
        ...
        this.baseExpertsUrl = '/api/experts';
    }
    DataService.prototype.getExperts = function () {
        return this.http.get(this.baseExpertsUrl)
            .map(function (experts) {
            return experts;
        })
            .catch(this.handleError);
    };
    DataService.prototype.getExpert = function (id) {
        return this.http.get(this.baseExpertsUrl + '/' + id)
            .catch(this.handleError);
    };
    DataService.prototype.getExpertsPage = function (page, pageSize) {
        return this.http.get(this.baseExpertsUrl + "/page/" + page + "/" + pageSize, { observe: 'response' })
            .map(function (res) {
            //Need to observe response in order to get to this header (see {observe: 'response'} above)
            var totalRecords = +res.headers.get('x-inlinecount');
            var experts = res.body;
            return {
                results: experts,
    ...
    DataService.prototype.insertExpert = function (expert) {
        return this.http.post(this.baseExpertsUrl, expert)
            .map(function (data) {
    ...
    DataService.prototype.updateExpert = function (expert) {
        return this.http.put(this.baseExpertsUrl + '/' + expert._id, expert)
            .map(function (data) {
    ...
    DataService.prototype.deleteExpert = function (id) {
        return this.http.delete(this.baseExpertsUrl + '/' + id)
            .catch(this.handleError);
    };
